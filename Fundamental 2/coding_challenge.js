...
1. Create an arrow functions "calcAverage" to calculate the average of 3 scores
...
and then logs the winner to the console together with the victory points, according to the rule above. Eg: "Koalas win (30 vs. 13)".
